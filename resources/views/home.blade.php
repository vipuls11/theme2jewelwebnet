@section('meta', '| Your Luxury Jewelry Store | Evolving Since 1996')
    @extends('app')
    @section('content')
...
/>
    ...
    <div class="grid lg:grid-cols-4 md:grid-cols-2 gap-4 my-10 ">
        ...
        <div>
            <div class="product-wrapper relative h-96 lg:h-80">
                <img class="hover:scale-110 duration-700" src="{{asset('storage/Spotlights/'.$collect->image_name)}}" style="width:100%; height:100%;">
                <div class="layer">
        ...
        <div class="container-1 my-10">
            ...
            <div class=" grid lg:grid-cols-4 md:grid-cols-2 gap-4 mt-10">
                @foreach($Celebration_image as $image)
                    <div>
                        <div class="animate-wrapper h-96 lg:h-80">
                            <img   src="{{asset('storage/Celebrations/'.$image->image_name)}}" alt="" style="width:100%; height:100%;" >
                        </div>
